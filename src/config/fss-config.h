/* src/config/fss-config.h.  Generated from fss-config.h.in by configure.  */
/* src/config/fss-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "http://bit.FSSs"

/* Define to the full name of this package. */
#define PACKAGE_NAME "FSS Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "FSS Core 1.1.0"
