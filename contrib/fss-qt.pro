...
RESOURCES += src/qt/fss.qrc src/qt/fss_locale.qrc

TRANSLATIONS += src/qt/locale/fss_bg.ts \
                src/qt/locale/fss_de.ts \
                src/qt/locale/fss_en.ts \
                src/qt/locale/fss_es.ts \
                src/qt/locale/fss_fi.ts \
                src/qt/locale/fss_fr.ts \
                src/qt/locale/fss_it.ts \
                src/qt/locale/fss_ja.ts \
                src/qt/locale/fss_pl.ts \
                src/qt/locale/fss_pt.ts \
                src/qt/locale/fss_ru.ts \
                src/qt/locale/fss_sk.ts \
                src/qt/locale/fss_sv.ts \
                src/qt/locale/fss_vi.ts \
                src/qt/locale/fss_zh_CN.ts \
                src/qt/locale/fss_zh_TW.ts
